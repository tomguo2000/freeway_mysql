...
class BaseConfig(object):
    ...
    def build_db_uri(
        ...
        """Build remote app uri using specific environment variables."""
...
class DevelopmentConfig(BaseConfig):
    ...
    DEBUG = True
    SQLALCHEMY_DATABASE_URI = "mysql://freeway:pony2)))@47.100.138.122:33006/freeway"
...
class TestingConfig(BaseConfig):
    ...
    # Use in-memory SQLite app for testing
